...
public class JmsActiveMqTest {
	...
	public void loadConfig()
	{
	 ...
	 LOGGER.info("Ejecutando sendAndReciveMsg() JunitTest"); SpringJmsProducer
	 springJmsProducer = (SpringJmsProducer) context
	 .getBean("springJmsProducer");
	 springJmsProducer.sendMessage("@tb jms msg ActiveMq"); SpringJmsConsumer
	  springJmsConsumer = (SpringJmsConsumer) context
